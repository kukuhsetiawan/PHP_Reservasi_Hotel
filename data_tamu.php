...
<div class="widgets"><!-- 2 columns widgets -->
        ...
        <!-- Media table -->
<div class="widget">
            <div class="title"><span class="title-icon"><input type="checkbox" id="title-checkbox" name="title-checkbox" /></span><h6>Tabel Data tamu</h6></div>
            <table cellpadding="0" cellspacing="0" width="100%" class="standard-table checkbox-enabled medium-table" id="check-all-box">
                <thead>
                    <tr>
                        
                        
                      <td width="7%" ><div>ID Tamu<span></span></div></td>
                      <td width="16%" ><div>Nama Tamu<span></span></div></td>
					  <td width="20%" ><div>Alamat <span></span></div></td>
	...
	while($data = mysql_fetch_array($query))
	{
		...
		echo "<td><a href='hapus_tamu.php?id_tamu=".$data['id_tamu']."'>Hapus | </a><a href='edit_tamu.php?id_tamu=".$data['id_tamu']."'>Edit  </a></td>";
		echo "</tr>";
...
?>
    	...
    	<!-- Dynamic table -->
        	...
        	<div class="secondary-controller">
            	<ul>
                	<li><a href="tambah_tamu.php"title=""><img src="img/tambah_data.png" width="50" height="50" style="box-shadow:3px 3px 5px 1px #333333"><span>Tambah Data</span></a></li>
