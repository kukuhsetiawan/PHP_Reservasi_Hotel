...
<tr>
<td>
<form action="simpan_jasa.php" method="post" id="register-form" novalidate="novalidate">
    ...
    <div id="form-content">
        <fieldset>
            ...
            <div class="fieldgroup">
                <label for="firstname">ID jasa</label>
            ...
            <div class="fieldgroup">
                ...
                <textarea rows="4" cols="40" name="nama_jasa">
				</textarea>
            </div>

			 <div class="fieldgroup">
                <label for="lastname">No harga_jasa</label>
                <input type="text" name="harga_jasa">
            </div>
