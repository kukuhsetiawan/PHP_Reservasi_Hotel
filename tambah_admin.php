...
<tr>
<td>
<form action="simpan_admin.php" method="post" id="register-form" novalidate="novalidate">
    ...
    <div id="form-content">
        <fieldset>
            ...
            <div class="fieldgroup">
                <label for="firstname">ID admin</label>
                <input type="text" name="id_admin">
            </div>

            <div class="fieldgroup">
                <label for="lastname">ID jasa</label>
                <input type="text" name="id_jasa">
            </div>

            <div class="fieldgroup">
                <label for="email">ID kamar</label>
                <textarea rows="4" cols="40" name="id_kamar">
				</textarea>
            </div>
