...
<tr>
<td>
<form action="simpan_tamu.php" method="post" id="register-form" novalidate="novalidate">
    ...
    <div id="form-content">
        <fieldset>
            ...
            <div class="fieldgroup">
                <label for="firstname">ID tamu</label>
            ...
            <div class="fieldgroup">
                ...
                <textarea rows="4" cols="40" name="alamat">
				</textarea>
            </div>

			 <div class="fieldgroup">
                <label for="lastname">No Tlp</label>
