        ...
        <div class="wrapper">
        	<div class="secondary-controller">
            	<ul>
                	...
                	<li><a href="data_jasa.php" title=""><img src="img/beranda.png" width="80" height="80" style="box-shadow:3px 3px 5px 1px #333333"><span>Beranda</span></a></li>
<li><a href="jasa.php" title=""><img src="img/supplier.png" width="80" height="80" style="box-shadow:3px 3px 5px 1px #333333"><span>jasa</span></a></li>					
                    <li><a href="kamar.php" title=""><img src="img/data_barang.png" width="80" height="80" style="box-shadow:3px 3px 5px 1px #333333"><span>kamar</span></a></li>
					<li><a href="admin.php" title=""><img src="img/data_barang_masuk.png" width="80" height="80" style="box-shadow:3px 3px 5px 1px #333333"><span>admin</span></a></li>
...
$harga = $data['harga'];
	...
	?>	
		<form action="update_kamar.php" method="post" id="register-form" novalidate="novalidate">
    ...
    <div id="form-content">
        <fieldset>
         	...
         	<div class="fieldgroup">
                ...
                <input type="text" name="id_kamar" value="<?php echo $id_kamar ?>" readonly>
            </div>
            <div class="fieldgroup">
            ...
            <div class="fieldgroup">
                <label for="email">tipe_kamar</label>
                <textarea rows="4" cols="40" name="tipe_kamar"><?php echo $tipe_kamar ?>
				</textarea>
            </div>

			 <div class="fieldgroup">
                <label for="lastname">tgl_checkin</label>
                <input type="text" name="tgl_checkin" value="<?php  echo $tgl_checkin ?>">
            </div>
			
			<div class="fieldgroup">
                <label for="lastname">tgl_checkout</label>
                <input type="text" name="tgl_checkout" value="<?php  echo $tgl_checkout ?>">
            </div>
			<div class="fieldgroup">
