    ...
    JQUERY4U.UTIL =
    {
        setupFormValidation: function()
        {
            ...
            $("#register-form").validate({
                ...
                messages: {
                    firstname: "Silahkan Masukan Nama Depan Anda",
                    lastname: "Silahkan Masukan Nama Belakang Anda",
                    password: {
        ...
        <div class="wrapper">
        	<div class="secondary-controller">
            	<ul>
                	...
                	<li><a href="data_admin.php" title=""><img src="img/beranda.png" width="80" height="80" style="box-shadow:3px 3px 5px 1px #333333"><span>Beranda</span></a></li>
...
<?php
	...
	include 'connect.php';
	$query = mysql_query("SELECT * FROM edit WHERE id_admin = '$id_admin'");
	...
	?>	
		<form action="update_admin.php" method="post" id="register-form" novalidate="novalidate">
    ...
    <div id="form-content">
        <fieldset>
         	...
         	<div class="fieldgroup">
                <label for="lastname">ID admin </label>
                <input type="text" name="id_admin" value="<?php echo $id_admin ?>" readonly>
            </div>
            <div class="fieldgroup">
                <label for="lastname">ID jasa</label>
                <input type="text" name="id_jasa" value="<?php echo $id_jasa ?>">
            </div>

            <div class="fieldgroup">
                <label for="email">ID kamar</label>
                <textarea rows="4" cols="40" name="id_kamar"><?php echo $id_kamar ?>
				</textarea>
            </div>

			 <div class="fieldgroup">
                <label for="lastname">ID tamu</label>
                <input type="text" name="id_tamu" value="<?php  echo $id_tamu ?>">
            </div>
			
			 <div class="fieldgroup">
                <label for="lastname">nama</label>
                <input type="text" name="id_tamu" value="<?php  echo $nama ?>">
            </div>
