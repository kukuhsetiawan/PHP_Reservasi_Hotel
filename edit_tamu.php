...
<?php
	...
	include 'connect.php';
	$query = mysql_query("SELECT * FROM tamu WHERE id_tamu = '$id_tamu'");
	...
	?>	
		<form action="update_tamu.php" method="post" id="register-form" novalidate="novalidate">
    ...
    <div id="form-content">
        <fieldset>
         	...
         	<div class="fieldgroup">
                ...
                <input type="text" name="id_tamu" value="<?php echo $id_tamu ?>" readonly>
            </div>
            <div class="fieldgroup">
                <label for="lastname">Nama tamu</label>
                <input type="text" name="nama" value="<?php echo $nama ?>">
            </div>

            <div class="fieldgroup">
                <label for="email">Alamat</label>
                <textarea rows="4" cols="40" name="alamat"><?php echo $alamat ?>
				</textarea>
            </div>

			 <div class="fieldgroup">
                <label for="lastname">tlp</label>
