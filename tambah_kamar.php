...
<li><a href="data_jasa.php" title=""><img src="img/supplier.png" width="80" height="80" style="box-shadow:3px 3px 5px 1px #333333"><span>jasa</span></a></li>					
					...
					<li><a href="data_dmin.php" title=""><img src="img/data_barang_masuk.png" width="80" height="80" style="box-shadow:3px 3px 5px 1px #333333"><span>admin</span></a></li>
                </ul>
          </div>
        </div>
    </div>
...
<tr>
<td>
<form action="simpan_kamar.php" method="post" id="register-form" novalidate="novalidate">
    ...
    <div id="form-content">
        <fieldset>
            ...
            <div class="fieldgroup">
                <label for="firstname">ID kamar</label>
                <input type="text" name="id_kamar">
            </div>

            <div class="fieldgroup">
                <label for="lastname">id_tamu </label>
                <input type="text" name="id_tamu">
            </div>

            <div class="fieldgroup">
                <label for="email">tipe_kamar</label>
                <textarea rows="4" cols="40" name="tipe_kamar">
				</textarea>
            </div>

			 <div class="fieldgroup">
                <label for="lastname"> tgl_checkin</label>
                <input type="text" name="tgl_checkin">
            </div>
			
			<div class="fieldgroup">
                <label for="lastname"> tgl_checkout</label>
                <input type="text" name="tgl_checkout">
            </div>
